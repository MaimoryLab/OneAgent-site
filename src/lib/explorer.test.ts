  ...
  providers: [
    {
      ...
      keyManagementUrl: "https://first.example/keys",
      baseUrl: "https://first.example/openai",
      anthropicBaseUrl: "https://first.example/anthropic",
      defaultModel: "model-default",
      fallbackProbeModel: "model-fallback",
      relationship: "none",
      disclosure: "",
      referralUrl: "",
      order: 1,
    ...
    },
    {
      ...
      keyManagementUrl: "https://verified.example/keys",
      baseUrl: "https://verified.example/openai",
      anthropicBaseUrl: "https://verified.example/anthropic",
      defaultModel: "model-default",
      fallbackProbeModel: "model-fallback",
      relationship: "none",
      disclosure: "",
